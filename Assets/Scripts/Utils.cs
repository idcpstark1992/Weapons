...
public static class Utils
{
    ...
    public static float DeacelerationValue { get; private set; }
    ...
    public static List<Rigidbody> EffectorsReferences ()
    {
        return AffectedItemsList;
    }
    public static void ChangeGravitationalBulletStatus(bool _newStatus)
    {
        GravitationaBullet = _newStatus;
    }
    public static void SetCustomWeaponMode (bool _newStatus)
    {
        CustomBulletMode = _newStatus;
    }
}